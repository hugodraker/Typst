...
#line-chart((("Prod A", 45), ("Prod B", 110), ("Prod C", 75)), color: "random", title: [*Product Performance Overview*], x-label: "Products", y-label: "Revenue ($)", trend-line: true)
#line-chart((("aassaas", 145), ("fs", 10), ("Prod C", 275)), color: "random", title: [*Prhmance Overview*], x-label: "Products", y-label: "Revenue ($)", trend-line: true)
